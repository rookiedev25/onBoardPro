          ...
          <form>
            ...
            <div className="mb-4">
              <select
                ...
                name="email"
                placeholder="domain"
                className="py-2 px-3 border border-gray-300 focus:border-green-600 focus:outline-none focus:ring focus:ring-green-100 focus:ring-opacity-50 rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full cursor-pointer"
              >
                <option value="">Select Domain</option>
                <option value="1">Smart Buildings</option>
                <option value="2">Mobilty</option>
              </select>
            </div>
            <div className="mb-4">
              <input
